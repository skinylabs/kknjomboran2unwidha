...
export default function Home() {
  return (
    <div className="h-screen bg-slate-900 overflow-hidden">
      ...
      <div className="flex flex-col text-center font-semibold text-[#edddc2] pt-4">
        <h1 className="text-xl">KKN JOMBORAN 2</h1>
        <p className="text-xl">UNIVERSITAS WIDYA DHARMA</p>
        <p className="text-xl">
